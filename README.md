...
- [Clear Telegram Userbot](https://github.com/DOLLDI/Clear-Telegram-Userbot) — юзер-бот для массовой очистки архива Telegram: автоматический выход из каналов, удаление ботов, групп и удалённых аккаунтов, личные чаты не затрагиваются
